...
parser.add_argument('--model', type=str, required=True, default='informerlight(TBD)',help='model of experiment, options: [informer, informerstack, informerlight(TBD)]')

parser.add_argument('--data', type=str, required=True, default='HPC', help='data')
parser.add_argument('--root_path', type=str, default='./data/', help='root path of the data file')
parser.add_argument('--data_path', type=str, default='IHPC.csv.csv', help='data file')    
...
parser.add_argument('--seq_len', type=int, default=180, help='input sequence length of Informer encoder')
parser.add_argument('--label_len', type=int, default=90, help='start token length of Informer decoder')

parser.add_argument('--pred_len', type=int, default=24, help='prediction sequence length')

parser.add_argument('--enc_in', type=int, default=180, help='encoder input size')
parser.add_argument('--dec_in', type=int, default=90, help='decoder input size')
...
data_parser = {
    'HPC':{'data':'IHPC.csv','T':'Global_active_power','M':[7,7,7],'S':[1,1,1],'MS':[7,7,1]},
}
