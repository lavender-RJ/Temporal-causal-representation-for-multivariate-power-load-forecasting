...
class FourierCrossAttention(nn.Module):
    def __init__(self, in_channels, out_channels, seq_len_q, seq_len_kv, modes=20, mode_select_method='random',
        ...
        print('modes_kv={}, index_kv={}'.format(len(self.index_q), self.index_kv))
